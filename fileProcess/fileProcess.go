...
// This might be hard to change in the future - can we construct a concrete struct instead of an interface{}? Then we can define a function to serialize that struct
